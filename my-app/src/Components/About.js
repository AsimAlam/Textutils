...
export default function About(probs) {
    ...
    // })
    let myStyle = {
      color : probs.mode === 'dark'? 'white': 'rgb(38 15 76)',
      backgroundColor : probs.mode === 'dark'? 'rgb(38 15 76)' : 'white',
      // border : '2px solid',
      // borderColor : probs.mode === 'dark'? 'white': 'rgb(38 15 76)'
    }
  ...
  return (
    <div className = "container" style = {{color : probs.mode === 'dark'? 'white': 'rgb(38 15 76)'}} >
